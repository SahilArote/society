...
async function testE2E() {
    ...
    const dummyPhotoPath = path_1.default.join(__dirname, '../uploads/test_camera_photo.jpg');
    ...
    fs_1.default.writeFileSync(dummyPhotoPath, 'DUMMY_IMAGE_BINARY_DATA_SIMULATING_GUARD_CAMERA_CAPTURE');
    ...
    const residentJson = await residentRes.json();
    const foundReq = residentJson.data?.find((r) => r.id === requestId);
    ...
    const adminActivityItem = adminJson.data?.find((a) => a.id === requestId);
