...
async function seedMysqlData(pool) {
    try {
        ...
        // 1. Society
        await pool.query(`INSERT INTO societies (id, name, address, status) VALUES (?, ?, ?, ?)`, ['soc_greengate', 'Green Valley Residency', 'Plot 42, Security Enclave, Cyber City', 'ACTIVE']);
        // 2. Gates
       ...
       ('admin_user', 'Admin Secretary', '9999988888', 'admin@greengate.in', ?, NULL, 'ADMIN', 'soc_greengate', 'ACTIVE')`, [guardPinHash, adminPasswordHash]);
        // 4. Flats
